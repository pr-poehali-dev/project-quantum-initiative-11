...
const steps = [
  {
    ...
    description: "Испытываем образцы в своей лаборатории и передаем аккредитованным партнерам. На выходе — протоколы испытаний.",
    icon: "FlaskConical",
  },
  {
    number: "II",
    title: "Санитарно-эпидемиологическая экспертиза",
    description: "Оценку проводит орган инспекции ФБУЗ «Центр гигиены и эпидемиологии». Получаем Экспертное заключение.",
    icon: "ClipboardCheck",
  },
  {
    number: "III",
    title: "Регистрация в департаменте РПН",
    description: "Итоговый этап. Вы получаете бланк СГР и запись в ЕАС.",
    icon: "ShieldCheck",
  },
]
